...
bool GameOverScene::init()
{
	...
	key_listener->onKeyPressed = CC_CALLBACK_2(GameOverScene::OnKeyPress, this);
	_eventDispatcher->addEventListenerWithSceneGraphPriority(key_listener, this);
	return true;
}

void GameOverScene::OnKeyPress(cocos2d::EventKeyboard::KeyCode keyCode, cocos2d::Event * event)
{
	switch (keyCode)
	{
	default:
